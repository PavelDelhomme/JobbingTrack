...
- **Solution** : Base de données créée + utilisateur `pavel@jobbingtrack.com` créé
- **Rôle** : `SUPER_ADMIN`
...
### Court terme
1. ✅ **Connexion** : Testez avec `pavel@jobbingtrack.com` / `password123`
...
- ✅ Connexion avec `pavel@jobbingtrack.com` (SUPER_ADMIN)
