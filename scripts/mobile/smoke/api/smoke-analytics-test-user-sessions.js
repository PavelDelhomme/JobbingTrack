 ...
 *
 *   node scripts/mobile/smoke/api/smoke-analytics-test-user-sessions.js
 */

const { resolveWorkingAdminCredentials, GATEWAY_URL, loadRootEnv } = require('../../lib/resolve-admin-credentials');
