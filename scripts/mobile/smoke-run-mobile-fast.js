...
const apiSequential = ['scripts/mobile/smoke-full-journey-api.js'];
...
const adbTests = [
  ...
  'scripts/mobile/smoke-mobile-fab-call-entretien-adb.js',
...
const adbLast = ['scripts/mobile/smoke-mobile-admin-hub-adb.js'];
