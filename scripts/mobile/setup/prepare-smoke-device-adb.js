...
async function main() {
  ...
  console.log(
    'Prefs: test_automation_skip_biometric=true, auth_keep_logged_in=true (biométrie produit intacte)',
  );
  console.log('Après smokes : node scripts/mobile/clear-smoke-device-adb.js');
}
