 ...
 *   node scripts/mobile/configure-emulator-bluemail.js --check-only
 */
...
(async () => {
  ...
  if (!pkg) {
    console.error('BlueMail non installé — lancez : node scripts/mobile/install-emulator-bluemail.js');
    process.exit(1);
  }
