...
make_request "POST" "/api/v1/auth/login" '{"email":"admin@test.com","password":"test"}' "200"
make_request "POST" "/api/v1/auth/login" '{"email":"root@test.com","password":"test"}' "200"
make_request "POST" "/api/v1/auth/login" '{"email":"test@test.com","password":"test"}' "200"
...
make_request "POST" "/api/v1/auth/login" '{"email":"test@test.com","password":"\' OR \'1\'=\'1"}' "200"
