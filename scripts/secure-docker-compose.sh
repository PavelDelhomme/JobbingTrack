...
sed -i 's|DATABASE_URL=postgresql://admin@jobbingtrack.com:admin@jobbingtrack.com@postgres:5432/jobbingtrack|DATABASE_URL=postgresql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@postgres:5432/${POSTGRES_DB}|g' docker-compose.yml
