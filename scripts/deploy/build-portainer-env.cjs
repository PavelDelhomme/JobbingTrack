...
const PREPROD_OVERRIDES = {
  ...
  NEXT_PUBLIC_API_GATEWAY_URL: 'https://api-preprod.jobbingtrack.com',
  NEXT_PUBLIC_AUTH_SERVICE_URL: 'https://api-preprod.jobbingtrack.com',
  NEXT_PUBLIC_FRONTEND_URL: 'https://preprod.jobbingtrack.com',
  NEXT_PUBLIC_USER_FRONTEND_URL: 'https://preprod.jobbingtrack.com',
  NEXT_PUBLIC_BACKOFFICE_URL: 'https://backoffice-preprod.jobbingtrack.com',
  FRONTEND_URL: 'https://preprod.jobbingtrack.com',
  FRONTEND_PUBLIC_URL: 'https://preprod.jobbingtrack.com',
  APP_URL: 'https://preprod.jobbingtrack.com',
  BACKEND_URL: 'https://api-preprod.jobbingtrack.com',
  BACKOFFICE_FRONTEND_URL: 'https://backoffice-preprod.jobbingtrack.com',
  USER_FRONTEND_URL: 'https://preprod.jobbingtrack.com',
  DEV_HTTPS_API_URL: 'https://api-preprod.jobbingtrack.com',
  DEV_HTTPS_FRONTEND_URL: 'https://preprod.jobbingtrack.com',
  PUBLIC_API_URL: 'https://api-preprod.jobbingtrack.com',
  API_GATEWAY_PUBLIC_URL: 'https://api-preprod.jobbingtrack.com',
  GOOGLE_OAUTH_REDIRECT_URI:
    'https://api-preprod.jobbingtrack.com/api/v1/email-agent/oauth/google/callback',
  ALLOWED_ORIGINS:
    'https://preprod.jobbingtrack.com,https://api-preprod.jobbingtrack.com,https://backoffice-preprod.jobbingtrack.com',
...
const PROD_OVERRIDES = {
  ...
  NEXT_PUBLIC_API_GATEWAY_URL: 'https://api.jobbingtrack.com',
  NEXT_PUBLIC_AUTH_SERVICE_URL: 'https://api.jobbingtrack.com',
  NEXT_PUBLIC_FRONTEND_URL: 'https://jobbingtrack.com',
  NEXT_PUBLIC_USER_FRONTEND_URL: 'https://jobbingtrack.com',
  NEXT_PUBLIC_BACKOFFICE_URL: 'https://backoffice.jobbingtrack.com',
  FRONTEND_URL: 'https://jobbingtrack.com',
  FRONTEND_PUBLIC_URL: 'https://jobbingtrack.com',
  APP_URL: 'https://jobbingtrack.com',
  BACKEND_URL: 'https://api.jobbingtrack.com',
  BACKOFFICE_FRONTEND_URL: 'https://backoffice.jobbingtrack.com',
  USER_FRONTEND_URL: 'https://jobbingtrack.com',
  DEV_HTTPS_API_URL: 'https://api.jobbingtrack.com',
  DEV_HTTPS_FRONTEND_URL: 'https://jobbingtrack.com',
  PUBLIC_API_URL: 'https://api.jobbingtrack.com',
  API_GATEWAY_PUBLIC_URL: 'https://api.jobbingtrack.com',
  GOOGLE_OAUTH_REDIRECT_URI:
    'https://api.jobbingtrack.com/api/v1/email-agent/oauth/google/callback',
  ALLOWED_ORIGINS:
    'https://jobbingtrack.com,https://www.jobbingtrack.com,https://api.jobbingtrack.com,https://backoffice.jobbingtrack.com',
