...
show_help() {
    ...
    echo ""
    echo "Liens modifiés:"
    echo "  • https://github.com/PavelDelhomme/JobbingTrack/blob/main/docs/file.md → docs/file.md"
    echo "  • https://github.com/PavelDelhomme/JobbingTrack/blob/main/README.md → /README.md"
    echo "  • https://github.com/PavelDelhomme/JobbingTrack/raw/main/docs/pdfs/file.pdf → docs/pdfs/file.pdf"
}
...
fix_file_links() {
    ...
    while IFS= read -r line; do
        ...
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/|/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/|docs/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/pdfs/|docs/pdfs/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/guides/|docs/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/technical/|docs/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/api/|docs/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/deployment/|docs/|g')
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/blob/main/docs/scripts/|scripts/|g')

        # Remplacer les liens GitHub raw par des liens vers les PDFs
        updated_line=$(echo "$updated_line" | sed 's|https://github\.com/PavelDelhomme/JobbingTrack/raw/main/docs/pdfs/|docs/pdfs/|g')
