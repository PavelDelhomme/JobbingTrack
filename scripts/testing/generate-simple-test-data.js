...
try {
  ...
  console.log('   1. user1@jobbingtrack.com (SUPER_ADMIN) - password123');
  console.log('   2. user2@jobbingtrack.com (ADMIN) - password123');
  console.log('   3. user3@jobbingtrack.com (USER) - password123');
  console.log('   4. user4@jobbingtrack.com (USER) - password123');
  console.log('');
