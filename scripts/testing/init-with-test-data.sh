...
if [ $? -eq 0 ]; then
    ...
    echo "   1. user1@jobbingtrack.test (SUPER_ADMIN) - password123"
    echo "   2. user2@jobbingtrack.test (ADMIN) - password123"
    echo "   3. user3@jobbingtrack.test (USER) - password123"
    echo "   4. user4@jobbingtrack.test (USER) - password123"
    echo ""
