...
4. **Vérifier que le reste tourne** – `make up-full` puis Tests API 36/36, connexion backoffice (admin@jobbingtrack.com / password123), `make create-admin-user` si « Accès Refusé ».
