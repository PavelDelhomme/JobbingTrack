...
- [x] Adresse email de reception reelle pour tests : `test@example.invalid` (via variable `TEST_REAL_EMAIL` dans `.env`, gitignored)
...
- [x] Tests email (Jest) utilisent `REAL_TEST_EMAIL` au lieu de `redacted@example.invalid` hardcode
