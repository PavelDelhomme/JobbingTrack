...
- **user1@jobbingtrack.test** (SUPER_ADMIN) - password123
- **user2@jobbingtrack.test** (ADMIN) - password123
- **user3@jobbingtrack.test** (USER) - password123
- **user4@jobbingtrack.test** (USER) - password123
