...
- ✅ `paul.delh@gmail.com` reçoive les emails de vérification
- ✅ `paul.delh@gmail.com` reçoive les emails de reset password
...
### Étape 1.2 : Créer l'Adresse Email `noreply@maily.ovh`
...
# Résultat attendu : noreply@maily.ovh
```
...
**Logs de SUCCÈS** :
```
✅ Email de reset password envoyé à paul.delh@gmail.com
```
...
→ Email noreply@maily.ovh pas créé ou pas actif
```
...
2. Email `noreply@maily.ovh` pas créé
...
1. Manager OVH → Emails → `maily.ovh`
2. Cliquer sur "..." à côté de `noreply@maily.ovh`
...
**Cause** : Email `noreply@maily.ovh` pas reconnu ou pas actif
...
Type : TXT
Nom : _dmarc
Valeur : v=DMARC1; p=none; rua=mailto:admin@maily.ovh
```
...
- [ ] Email reçu dans Gmail (paul.delh@gmail.com) ✅
...
```
Utilisateur s'inscrit avec paul.delh@gmail.com
         ↓
...
│                                                          │
│  Tests :                                                 │
│    ✅ Reset password → paul.delh@gmail.com reçoit       │
...
2. **Tester** avec `paul.delh@gmail.com`
