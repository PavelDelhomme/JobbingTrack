...
| **SMTP_USER** | Votre identifiant (comme votre nom d'expéditeur) | `redacted@example.invalid` |
| **SMTP_PASS** | Votre mot de passe (pour prouver que c'est vous) | `motdepasse123` |
| **SMTP_FROM** | Le nom qui apparaîtra comme expéditeur | `"JobbingTrack <redacted@example.invalid>"` |
...
3. Entrer l'email `noreply@jobbingtrack.test` (ou votre domaine)
...
4. Remplir le formulaire :
   - From Email : `noreply@jobbingtrack.test` (ou votre email)
...
- ✅ Vous voulez un email professionnel (`redacted@example.invalid`)
...
5. Remplir :
   - Nom du compte : `noreply` (donnera `redacted@example.invalid`)
