...
Pour savoir **ce qu’il faut faire** (priorité mobile, vérification email, suite Flutter) → **[STATUS.md](STATUS.md)** (section « À faire maintenant ») et **[docs/mobile/PROCHAINES_ETAPES.md](docs/mobile/PROCHAINES_ETAPES.md)**.
