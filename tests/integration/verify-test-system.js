 ...
 * Vérifie que user1@jobbingtrack.com existe et que la route /api/v1/services fonctionne
 */
...
// Test 2: Vérifier l'utilisateur user1@jobbingtrack.com
async function testUser1Login() {
  console.log('\n👤 Test 2: Connexion avec user1@jobbingtrack.com');
...
async function runAllTests() {
  ...
  if (passed === total) {
    ...
    console.log('✅ user1@jobbingtrack.com disponible');
