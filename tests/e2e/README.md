...
cd tests && TEST_REAL_EMAILS=pauldelhomme.pro@gmail.com npx playwright test e2e/specs/mobile/mobile-email-verification-gmail.spec.ts --project=chromium

# Spec mobile Proton
cd tests && TEST_REAL_EMAILS=paul.delhomme@proton.me npx playwright test e2e/specs/mobile/mobile-email-verification-proton.spec.ts --project=chromium

# Spec mobile BlueMail
cd tests && TEST_REAL_EMAILS=candidatures@delhomme.ovh npx playwright test e2e/specs/mobile/mobile-email-verification-bluemail.spec.ts --project=chromium
```
