 ...
 * Avec email reel : TEST_REAL_EMAILS=pauldelhomme.pro@gmail.com
 */
...
const GMAIL_EMAIL = process.env.TEST_REAL_EMAILS?.split(',')[0]?.trim() || process.env.TEST_REAL_EMAIL || 'pauldelhomme.pro@gmail.com';
