 ...
 * Avec email reel : TEST_REAL_EMAILS=job-search-mailbox@example.invalid
 */
...
const GMAIL_EMAIL = process.env.TEST_REAL_EMAILS?.split(',')[0]?.trim() || process.env.TEST_REAL_EMAIL || 'job-search-mailbox@example.invalid';
