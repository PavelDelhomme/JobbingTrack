/**
 * Logger centralisé vers metrics-aggregator (source: backend/shared/utils/centralLogger.js)
...
const SERVICE_NAME = process.env.SERVICE_NAME || process.env.npm_package_name || 'application-service';
