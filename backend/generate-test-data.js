...
const FIRST_NAMES = ['Admin', 'Marie', 'Thomas', 'Sophie', 'Alexandre', 'Camille', 'Nicolas', 'Emma', 'Julien', 'Léa'];
const LAST_NAMES = ['JobbingTrack', 'Martin', 'Bernard', 'Dubois', 'Thomas', 'Robert', 'Petit', 'Durand', 'Leroy', 'Moreau'];
...
async function main() {
  ...
  try {
    ...
    // La gateway peut passer un id factice (ex. user-123) ou un email (ex. user@jobbingtrack.test) alors que le seed crée admin@jobbingtrack.test.
