...
2. Connectez-vous avec `pavel@jobbingtrack.com` / `password123`
...
- `user1@jobbingtrack.com` - **SUPER_ADMIN** (accès complet)
- `user2@jobbingtrack.com` - **ADMIN** (gestion administrative)
- `user3@jobbingtrack.com` - **USER** (utilisateur standard)
