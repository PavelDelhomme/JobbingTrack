/**
 * Logger centralisé vers metrics-aggregator (aligné sur application-service).
 */
...
const SERVICE_NAME = process.env.SERVICE_NAME || process.env.npm_package_name || 'contact-service';
