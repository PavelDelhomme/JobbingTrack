/**
 * Envoi WARN/ERROR gateway vers metrics-aggregator (contrat forensics, optionnel).
 */
...
const SERVICE_NAME = process.env.SERVICE_NAME || process.env.npm_package_name || 'api-gateway';
  ...
  async flushLogs() {
    ...
    try {
      ...
      if (process.env.NODE_ENV !== 'test') {
        console.error('[CENTRAL_LOGGER] api-gateway:', error.message);
      }
    }
  }
