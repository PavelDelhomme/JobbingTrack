 ...
 *   await phone.typeInField('Email', 'admin@jobbingtrack.com');
 *   await phone.assertVisible('Bonjour');
 *   const nodes = await phone.uiNodes();
 *
 *   // --- Methode 2 : Flows de haut niveau ---
 *   await adb.flows.loginFresh(phone, 'admin@jobbingtrack.com', 'password123');
 ...
 *   await adb.exec('mob_login', { email: 'admin@jobbingtrack.com' }, phone);
