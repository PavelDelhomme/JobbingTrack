...
| Email | Rôle | Accès |
|-------|------|-------|
| user1@jobbingtrack.com | **SUPER_ADMIN** | ✅ Tout |
| user2@jobbingtrack.com | **ADMIN** | ✅ Admin (sauf vidage corbeille) |
| user3@jobbingtrack.com | **USER** | ⚠️ Données personnelles uniquement |
...
**Date** : 2025-10-10  
**Auteur** : Assistant IA + Pavel Delhomme  
**Version** : 2.0  
