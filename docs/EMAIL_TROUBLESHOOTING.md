...
### Symptômes
- L'email est envoyé depuis `noreply@maily.ovh`
- Vous recevez un "Undelivered Mail Returned to Sender" dans la boîte `noreply@maily.ovh`
- Erreur : `connect to test.com[34.224.149.186]:25: Connection timed out`

### Causes possibles

1. **Adresse email invalide** : L'adresse `verify-1762509821@test.com` n'existe pas
...
3. **Vérifiez la boîte `noreply@maily.ovh`** pour les erreurs de livraison
