...
|-------|-----------------------|--------------------|
| Priorités sécurité/backoffice | `docs/pilotage/PILOTAGE.md`, `docs/TODOS.md` + `docs/PLAN.md` lot B/B14/B15 | `docs/pilotage/TODOS_A_VALIDER.md`, `docs/pilotage/TODOS_DONE.md`, `docs/STATUS.md` |
