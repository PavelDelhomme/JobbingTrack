...
- Créer `redacted@example.invalid`
...
- Test avec `redacted@example.invalid`
- Vérification Gmail
- Logs à surveiller
...
1. **PARTIE 1** : Créer `redacted@example.invalid` chez OVH (10 min)
...
5. Tester avec redacted@example.invalid
