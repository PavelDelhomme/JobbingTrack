# 🔍 Vérification du compte email noreply@jobbingtrack.com
...
2. Allez dans **Emails** → **noreply@jobbingtrack.com**
...
2. Connectez-vous avec :
   - **Email** : `noreply@jobbingtrack.com`
   - **Mot de passe** : `D^^DKAqR&uxF$s9HeBrX`
...
server.login('noreply@jobbingtrack.com', 'D^^DKAqR&uxF$s9HeBrX')
print('✅ OK')
server.quit()
```
