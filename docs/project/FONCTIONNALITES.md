...
- **Agent email / tâches recherche emploi** (prévu — lot **I**, non implémenté) : interface privée JobbingTrack dédiée, séparée du backoffice email système, pour tri des emails Gmail et boîte candidatures OVH, liaison aux candidatures/entreprises/contacts, stockage interne des emails utiles, tâches/relances/événements, digest quotidien à 18h, préparation entretiens, Google Tasks/Calendar obligatoires, moteur déterministe puis IA locale en renfort. Cadrage : `docs/features/EMAIL_TRIAGE_AGENT.md`.
