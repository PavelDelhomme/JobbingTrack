...
- **Agent email / tâches recherche emploi** (prévu — lot **I**, non implémenté) : tri des emails Gmail et `candidatures@example.invalid`, liaison aux candidatures/entreprises/contacts, tâches/relances/événements, digest quotidien à 18h, préparation entretiens, Google Tasks/Calendar optionnels et IA locale/optionnelle. Cadrage : `docs/features/EMAIL_TRIAGE_AGENT.md`.
