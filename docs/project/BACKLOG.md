...
| BL-26-09 | Toolchain mobile : Gradle ≥8.14, Built-in Kotlin Flutter, `pub outdated` (33 packages) — phase C1 |
| BL-26-10 | v2 : création relance/appel/entretien/contact via autocomplete candidature (hors détail) |
| BL-26-11 | v2 : intérim missions (onglets boîtes + missions, anti-doublon, pas modèle candidature) |
