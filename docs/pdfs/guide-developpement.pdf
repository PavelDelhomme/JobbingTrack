# Guide Développement - JobbingTrack
...
- **[Accueil](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/README.md)** | **[Documentation Centralisée](../README.md)**

### 🚀 **Démarrage Rapide**
- **[Guide Installation](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/GUIDE-DEMARRAGE-RAPIDE.md)** | **[Guide Développement](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/guides/getting-started.md)**

### 📡 **API & Intégration**
- **[Documentation API](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/api/v1/endpoints.md)** | **[API Technique](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/api.md)**

### 🚀 **Déploiement**
- **[Guide Déploiement](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/deployment/GUIDE-PORTAINER.md)** | **[Déploiement Technique](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/deployment.md)**

### 🛠️ **Outils Développement**
- **[Scripts et Makefiles](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/scripts/makefiles.md)** | **[Documentation Technique](../technical/README.md)**

### 🔧 **Documentation Technique**
- **[Architecture](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/architecture.md)** | **[Base de Données](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/database.md)** | **[Sécurité](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/security.md)** | **[Performance](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/performance.md)**
...
### 🚀 **Démarrage Rapide**
- **[Guide Installation](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/GUIDE-DEMARRAGE-RAPIDE.md)** | **[Guide Administration](./administration.md)**

### 📡 **API & Intégration**
- **[Documentation API](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/api/v1/endpoints.md)** | **[Documentation Technique](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/api.md)**

### 🚀 **Déploiement**
- **[Guide Déploiement](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/deployment/GUIDE-PORTAINER.md)** | **[Documentation Déploiement](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/technical/deployment.md)**
...
# Ou manuellement
./scripts/create-admin-user.sh admin@jobbingtrack.test SuperAdmin123!
```
...
- **💬 Discussions** : https://github.com/OWNER/JobbingTrack/discussions

### Contribution
```bash
# Fork le repository
git fork https://github.com/OWNER/JobbingTrack.git
...
**Questions ?** Consultez la [documentation technique](./../technical/README.md) ou ouvrez une [issue](https://github.com/OWNER/JobbingTrack/issues).
