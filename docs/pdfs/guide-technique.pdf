...
### 📡 **API & Intégration**
- **[Documentation API](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/api/v1/endpoints.md)** | **[API Technique](./api.md)**

### 🚀 **Déploiement**
- **[Guide Déploiement](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/deployment/GUIDE-PORTAINER.md)** | **[Déploiement Technique](./deployment.md)**

### 🛠️ **Outils Développement**
- **[Scripts et Makefiles](https://github.com/OWNER/JobbingTrack/blob/feat/frontend-dashboard/frontend-dashboard/docs/scripts/makefiles.md)** | **[Documentation Technique](./README.md)**
