...
- [ ] **Logs sécurité backoffice — fenêtre 30 j vs limite UI** : l’API filtre sur `startDate` (30 j) mais l’UI ne charge que **2000** entrées max (`SECURITY_LOGS_FETCH_LIMIT`) — afficher clairement « tronqué » ou pagination / fetch incrémental.
