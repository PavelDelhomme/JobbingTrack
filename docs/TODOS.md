...
- [ ] **Suite forensics menaces** : collecter des preuves techniques exploitables (request/payload rediges si sensible, `requestId`, endpoint, compte impacte, logs correles, action WAF/firewall) et ajouter seulement ensuite un enrichissement reseau optionnel (ASN/VPN/proxy/Tor) sans le presenter comme preuve d'attaque.
