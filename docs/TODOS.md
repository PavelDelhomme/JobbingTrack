...
- [ ] **Dependabot alerts → BDD sécurité** : implémenter l'import GitHub Dependabot dans `security-service` en mappant les alertes vers `Vulnerability` + `SecurityAlert` pour nouvelles `critical/high`; cadrage initial : `docs/security/DEPENDABOT_ALERTS_INTEGRATION.md`.
