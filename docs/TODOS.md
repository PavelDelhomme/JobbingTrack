...
**Dernière mise à jour : 13 mai 2026** — les tâches à faire passent en premier. Les succès techniques restent conservés plus bas, mais ils ne valent pas validation porteur. La validation finale est centralisée dans **`A_VALIDER_VERIFIER.md`**.
