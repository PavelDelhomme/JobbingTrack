...
- [ ] **Logs sécurité backoffice — fenêtre 30 j vs limite UI** : **pas de compression** en BDD ; plafond **2000** sur la vue d’ensemble (`SECURITY_LOGS_FETCH_LIMIT`), **100** sur `/security/logs`. Afficher « tronqué » + pagination API / rétention configurable.
