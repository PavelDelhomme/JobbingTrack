...
### 🚀 **Démarrage Rapide**
- **[Guide Installation](https://github.com/PavelDelhomme/JobbingTrack/blob/main/GUIDE-DEMARRAGE-RAPIDE.md)** | **[Guide Administration](./administration.md)**

### 📡 **API & Intégration**
- **[Documentation API](https://github.com/PavelDelhomme/JobbingTrack/blob/main/docs/api/v1/endpoints.md)** | **[Documentation Technique](https://github.com/PavelDelhomme/JobbingTrack/blob/main/docs/technical/api.md)**

### 🚀 **Déploiement**
- **[Guide Déploiement](https://github.com/PavelDelhomme/JobbingTrack/blob/main/docs/deployment/GUIDE-PORTAINER.md)** | **[Documentation Déploiement](https://github.com/PavelDelhomme/JobbingTrack/blob/main/docs/technical/deployment.md)**
