...
**Synthèse (indicatif)** — Technique **~62 %** (forensics **B6–B9** + UX **B10** ; **B14** infra compose **partiel**) · **Validé porteur** : **0/14** — à ajuster quand vous aurez rempli la colonne **Validé** (tableau lot B : **B1–B14**).
