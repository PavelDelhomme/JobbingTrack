...
[← Développement](../setup/README.md) | [← Documentation](../../README.md) | [← README principal](../../../README.md) | [🧭 Navigation](../../navigation.md)
...
- 📚 [Tests Racine](../../../tests/README.md) - Documentation complète du dossier tests/
- 📚 [Stratégie de Tests](../../tests/README.md) - Méthodologie de tests
- 📚 [Guide de Développement](../setup/README.md) - Configuration environnement
- 📚 [Guide Frontend](../../frontend/README.md) - Tests frontend spécifiques
- 📚 [Guide de l'API](../../api/api-reference/README.md) - Tests API
...
- ⚙️ setup.js - Configuration initiale complète
...
- **[Workflow Développement](../workflow/README.md)** - Processus de développement
- **[Documentation Makefile](../makefile/README.md)** - Commandes automatisées
- **[API Reference](../../api/api-reference/README.md)** - Documentation API
- **[Guide Sécurité](../../security/README.md)** - Bonnes pratiques sécurité
