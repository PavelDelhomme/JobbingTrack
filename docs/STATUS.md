...
- **Reste à planifier** : tests frontend/backend des états conteneurs (**arrêté**, **dégradé**, `unknown` actif), smoke navigateur log-stats après login porteur, vérification fonctionnelle du **taux d’erreur dans le temps**, et vérification granularité erreurs.
