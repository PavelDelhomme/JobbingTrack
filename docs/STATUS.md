...
- **Diagnostic alertes sur page Sécurité** : panneau « Derniers envois alertes » sur `/b4ck0ff1ce/security/alerts` (statut + miroir SMTP + messageId). Test E2E `security-service` → `notification-service` OK pour les 3 destinataires actifs.
