...
├── README-REORGANIZATION.md     # Documentation de la réorganisation
...
## 🗂️ Tests Réorganisés (Migration de la racine)
...
**📚 Documentation :** Voir `tests/README-REORGANIZATION.md` pour les détails complets de la réorganisation.
