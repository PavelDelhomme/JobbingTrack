...
**📚 La documentation complète du frontend est disponible dans la [documentation centralisée](https://github.com/PavelDelhomme/JobbingTrack/blob/feat/frontend-dashboard/docs/README.md)**
