...
test.describe("👑 Fonctionnalités Administrateur Avancées", () => {
  ...
  test("devrait permettre la gestion complète des utilisateurs", async ({
    page,
  }) => {
    ...
    await page.fill(
      'input[name="email"]',
      "nouveau.recruteur@jobbingtrack.com",
    );
  ...
  test("devrait permettre la gestion des rôles et permissions", async ({
    page,
  }) => {
    ...
    await page
      .locator("button")
      .filter({ hasText: /Nouveau rôle/ })
      .click();
    await page.fill('input[name="name"]', "Recruteur Senior");
    await page.fill(
      'input[name="description"]',
      "Rôle pour les recruteurs expérimentés",
    );
  ...
  test("devrait permettre la surveillance et les logs système", async ({
    page,
  }) => {
  ...
  test("devrait permettre la gestion des sauvegardes et restauration", async ({
    page,
  }) => {
    ...
    await page
      .locator("button")
      .filter({ hasText: /Créer sauvegarde/ })
      .click();
    ...
    await expect(
      page.locator("text=Sauvegarde quotidienne programmée"),
    ).toBeVisible();
    ...
    await page
      .locator("tr")
      .filter({ hasText: "Sauvegarde avant migration" })
      .locator("button")
      .filter({ hasText: /Restaurer/ })
      .click();
    await page
      .locator("button")
      .filter({ hasText: /Confirmer/ })
  ...
  test("devrait permettre la configuration système avancée", async ({
    page,
  }) => {
  ...
  test("devrait permettre l'audit et la conformité RGPD", async ({ page }) => {
    ...
    await page
      .locator("button")
      .filter({ hasText: /Rapport d\'audit/ })
      .click();
    await page.locator('input[name="dateFrom"]').fill("2025-01-01");
    ...
    await page
      .locator("button")
      .filter({ hasText: /Nouvelle demande/ })
      .click();
    ...
    await page
      .locator("tr")
      .filter({ hasText: "user@demande-suppression.com" })
      .locator("button")
      .filter({ hasText: /Traiter/ })
      .click();
    await page.locator('select[name="action"]').selectOption("DELETE");
    await page
      .locator("button")
      .filter({ hasText: /Exécuter/ })
      .click();
  ...
  test("devrait permettre la gestion des services et monitoring", async ({
    page,
  }) => {
    ...
    await page
      .locator("tr")
      .filter({ hasText: "application-service" })
      .locator("button")
      .filter({ hasText: /Redémarrer/ })
      .click();
    await page
      .locator("button")
      .filter({ hasText: /Confirmer/ })
  ...
  test("devrait permettre l'analyse avancée et les rapports personnalisés", async ({
    page,
  }) => {
    ...
    await page
      .locator("button")
      .filter({ hasText: /Nouveau rapport/ })
      .click();
    ...
    await page
      .locator("tr")
      .filter({ hasText: "Rapport recrutement mensuel" })
      .locator("button")
      .filter({ hasText: /Générer/ })
      .click();
  ...
  test("devrait gérer les incidents et le support technique", async ({
    page,
  }) => {
    ...
    await page
      .locator("button")
      .filter({ hasText: /Nouveau ticket/ })
      .click();
    await page.fill(
      'input[name="title"]',
      "Erreur 500 sur la page candidatures",
    );
    await page.fill(
      'textarea[name="description"]',
      "Les utilisateurs rencontrent une erreur 500...",
    );
    ...
    await page.fill(
      ...
      "Problème résolu - déploiement d'un correctif",
    );
