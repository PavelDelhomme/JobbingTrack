...
import { testUsers, testCompanies, testContacts, testApplications, apiMocks } from './test-data';
...
test.describe('🔗 Tests d\'Intégration - Microservices', () => {
  ...
  test('devrait synchroniser les données entre entreprises et contacts', async ({ page }) => {
    ...
    await page.fill('input[name="email"]', 'test@nouvelleentreprise.com');
    await page.fill('input[name="position"]', 'Manager');
    await page.locator('select[name="companyId"]').selectOption({ label: 'Nouvelle Entreprise Test' });
    await page.locator('button[type="submit"]').click();
    ...
    await page.locator('text=Entreprises').click();
    await page.locator('tr').filter({ hasText: 'Nouvelle Entreprise Test' }).locator('button').filter({ hasText: /Détails/ }).click();
  ...
  test('devrait maintenir la cohérence des données lors des modifications', async ({ page }) => {
    ...
    await page.locator('text=Entreprises').click();
    await page.locator('tr').filter({ hasText: 'TechStart Solutions' }).locator('button').filter({ hasText: /Modifier/ }).click();
    ...
    await page.locator('text=Contacts').click();
    await expect(page.locator('text=TechStart Solutions Updated')).toBeVisible();
  });
  ...
  test('devrait gérer correctement les dépendances entre services', async ({ page }) => {
    ...
    await page.locator('text=Entreprises').click();
    await page.locator('tr').filter({ hasText: 'TechStart Solutions' }).locator('button').filter({ hasText: /Modifier/ }).click();
    await page.fill('input[name="name"]', 'TechStart Solutions - Integration Test');
    await page.locator('button[type="submit"]').click();

    // Retourner aux candidatures et vérifier que la liaison est maintenue
    await page.locator('text=Applications').click();
    await expect(page.locator('text=TechStart Solutions - Integration Test')).toBeVisible();
  });
  ...
  test('devrait maintenir la cohérence lors des suppressions en cascade', async ({ page }) => {
    ...
    await page.fill('input[name="email"]', 'contact@test-suppression.com');
    await page.locator('select[name="companyId"]').selectOption({ label: 'Entreprise à Supprimer' });
    await page.locator('button[type="submit"]').click();
    ...
    await page.locator('text=Entreprises').click();
    await page.locator('tr').filter({ hasText: 'Entreprise à Supprimer' }).locator('button').filter({ hasText: /Supprimer/ }).click();
    ...
    await page.locator('text=Contacts').click();
    await expect(page.locator('text=contact@test-suppression.com')).not.toBeVisible();
  ...
  test('devrait gérer les conflits de données entre services', async ({ page }) => {
    ...
    await page.locator('tr').filter({ hasText: 'Développeur Full Stack Senior' }).locator('button').filter({ hasText: /Détails/ }).click();
    ...
    await expect(page.locator('button').filter({ hasText: /Corriger/ })).toBeVisible();
  });
  ...
  test('devrait maintenir l\'intégrité référentielle entre services', async ({ page }) => {
    ...
    await page.route('**/api/v1/companies/*', async route => {
      if (route.request().method() === 'DELETE') {
        await route.fulfill({
          ...
          contentType: 'application/json',
          body: JSON.stringify({
            error: 'Impossible de supprimer - entreprise référencée par des candidatures et contacts'
          })
        });
      }
    });
    ...
    await page.locator('text=Entreprises').click();
    await page.locator('tr').filter({ hasText: 'TechStart Solutions' }).locator('button').filter({ hasText: /Supprimer/ }).click();
