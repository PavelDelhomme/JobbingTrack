...
test.describe("🔗 Tests API uniquement - Fonctionnalités Backend", () => {
  ...
  test("📅 Récupération des entretiens", async ({ request }) => {
    ...
    const interviewsResponse = await request.get(
      `${config.apiUrl}/api/v1/interviews`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
          ...testHeaders,
  ...
  test("🔍 Recherche globale", async ({ request }) => {
    ...
    const searchResponse = await request.get(
      `${config.apiUrl}/api/v1/search?query=test`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
          ...testHeaders,
  ...
  test("📈 Métriques système", async ({ request }) => {
    ...
    const metricsResponse = await request.get(
      `${config.apiUrl}/api/v1/dashboard/stats`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
          ...testHeaders,
...
test.describe("🚫 Tests de sécurité API", () => {
  ...
  test("🚪 Accès à des endpoints admin avec utilisateur normal", async ({
    request,
  }) => {
    ...
    const usersResponse = await request.get(
      `${config.apiUrl}/api/v1/auth/users`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
          ...testHeaders,
...
test.describe("📊 Tests de performance API", () => {
  test("⚡ Performance des requêtes API", async ({ request }) => {
    ...
    // Requêtes parallèles
    const requests = [
      request.get(`${config.apiUrl}/api/v1/companies`, {
        headers: { Authorization: `Bearer ${token}`, ...testHeaders },
      }),
      request.get(`${config.apiUrl}/api/v1/contacts`, {
        headers: { Authorization: `Bearer ${token}`, ...testHeaders },
      }),
      request.get(`${config.apiUrl}/api/v1/applications`, {
        headers: { Authorization: `Bearer ${token}`, ...testHeaders },
      }),
      request.get(`${config.apiUrl}/api/v1/dashboard/kpis`, {
        headers: { Authorization: `Bearer ${token}`, ...testHeaders },
      }),
    ];
