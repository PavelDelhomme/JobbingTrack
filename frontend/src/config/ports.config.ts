...
export const EXTERNAL_PORTS = {
  FRONTEND: parseInt(process.env.NEXT_PUBLIC_FRONTEND_PORT || '8080', 10),
  API_GATEWAY: parseInt(process.env.NEXT_PUBLIC_API_GATEWAY_PORT || '3000', 10),
  ...
  METRICS_AGGREGATOR: parseInt(process.env.NEXT_PUBLIC_METRICS_AGGREGATOR_PORT || '8014', 10),
