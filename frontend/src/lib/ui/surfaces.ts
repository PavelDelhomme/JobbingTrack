...
export const uiSurfaces = {
  ...
  tableWrap:
    "overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900",
  tableHead: "bg-gray-50 dark:bg-gray-800/80 text-left",
  emptyState:
    "rounded-lg border border-dashed border-gray-300 dark:border-gray-600 bg-gray-50/50 dark:bg-gray-900/40 p-8 text-center text-sm text-gray-600 dark:text-gray-400",
} as const;
