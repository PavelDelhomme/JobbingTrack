...
export const MOBILE_SCENARIOS: Record<string, MobileScenario> = {
  ...
  mobile_register_verify_gmail: {
    ...
    description: 'Inscription avec pauldelhomme.pro@gmail.com → accepter conditions → valider → ouvrir Gmail → ouvrir mail → cliquer lien → retour app → connexion avec le même email',
  ...
  mobile_register_verify_proton: {
    ...
    description: 'Inscription avec paul.delhomme@proton.me → accepter conditions → valider → ouvrir Proton → mail → lien → retour app → connexion',
    category: 'verification',
    steps: [
      'go_to_home_then_launch_app', 'wait_for_app_ready', 'ensure_logged_out', 'scroll_to_register', 'go_to_register',
  ...
  mobile_register_verify_bluemail: {
    ...
    description: 'Inscription avec candidatures@delhomme.ovh → accepter conditions → valider → ouvrir BlueMail → mail → lien → retour app → connexion',
    category: 'verification',
    steps: [
      'go_to_home_then_launch_app', 'wait_for_app_ready', 'ensure_logged_out', 'scroll_to_register', 'go_to_register',
