...
export const MOBILE_SCENARIOS: Record<string, MobileScenario> = {
  ...
  mobile_registration: {
    ...
    description: 'Inscription désactivée dans les tests. Inscrivez-vous manuellement puis utilisez les parcours vérif. email.',
    category: 'auth',
    steps: ['go_to_home_then_launch_app', 'wait_for_app_ready', 'ensure_logged_out', 'view_dashboard_ui'],
  },
  ...
  mobile_register_verify_gmail: {
    ...
    description: 'Compte déjà inscrit à la main. Connexion écran → ouvrir Gmail → mail vérif → cliquer lien → retour app → connexion',
    category: 'verification',
    steps: [
      'go_to_home_then_launch_app', 'wait_for_app_ready', 'ensure_logged_out',
      'open_gmail', 'gmail_open_first_email', 'gmail_tap_verification_link',
  ...
  mobile_register_verify_proton: {
    ...
    description: 'Compte déjà inscrit à la main. Ouvrir Proton → mail → lien → retour app → connexion',
    category: 'verification',
    steps: [
      'go_to_home_then_launch_app', 'wait_for_app_ready', 'ensure_logged_out',
      'open_proton', 'gmail_open_first_email', 'gmail_tap_verification_link',
  ...
  mobile_register_verify_bluemail: {
    ...
    description: 'Compte déjà inscrit à la main. Ouvrir BlueMail → mail → lien → retour app → connexion',
    category: 'verification',
    steps: [
      'go_to_home_then_launch_app', 'wait_for_app_ready', 'ensure_logged_out',
      'open_bluemail', 'gmail_open_first_email', 'gmail_tap_verification_link',
