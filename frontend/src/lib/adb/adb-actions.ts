...
export const MOBILE_ACTIONS: MobileAction[] = [
  ...
  },
  {
    ...
    icon: '🔐',
    params: [
      { key: 'email', label: 'Email', type: 'text', default: 'admin@jobbingtrack.com', placeholder: 'Email de connexion', required: true },
  ...
  // ─── Saisie ────────────────────────────────────────────────────
  {
    ...
    params: [
      ...
      { key: 'value', label: 'Texte a saisir', type: 'text', placeholder: 'Ex: admin@jobbingtrack.com', required: true },
    ],
  },
  {
