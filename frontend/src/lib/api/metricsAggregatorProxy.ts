...
export type MetricsAggregatorRouteContext = {
  params: Promise<{ path?: string[] }>;
};

/** Proxy HTTP vers metrics-aggregator (injecte METRICS_API_KEY côté serveur Next). */
export async function proxyMetricsAggregatorRequest(
  request: NextRequest,
