 ...
 */
export function formatRangeLabel(start: Date, end: Date, range: TimeRangeOption): string {
...
export function formatCustomRangeLabel(ymdStart: string, ymdEnd: string): string {
  const locale = defaultLocale();
...
export function localCalendarDayBounds(ymdStart: string, ymdEnd: string): { start: Date; end: Date } {
