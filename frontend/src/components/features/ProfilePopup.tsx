...
export function ProfilePopup({ isOpen, onClose }: ProfilePopupProps) {
  ...
  const updateRefreshInterval = (
    key: keyof UserPreferences["refreshInterval"],
    value: number,
  ) => {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateRefreshInterval("logs", parseInt(e.target.value))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateRefreshInterval("metrics", parseInt(e.target.value))
                    }
                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700 accent-blue-600"
                  />
                </div>
              ...
              <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <p className="text-xs text-blue-800 dark:text-blue-300">
                  ...
                  offrent des données plus fraîches mais augmentent la charge
                  réseau.
                </p>
              </div>
            </div>
