                ...
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  ...
                  <button
                    onClick={() => {
                      ...
                      const testData = {
                        user: [
                          { id: '1', email: 'test@example.com', firstName: 'Test', lastName: 'User', role: 'USER', is_active: true },
                          { id: '2', email: 'admin@example.com', firstName: 'Admin', lastName: 'User', role: 'ADMIN', is_active: false }
                        ],
                        company: [
