    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div className="text-gray-600 dark:text-gray-400 text-sm">Utilisateurs</div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-900 dark:text-gray-100">{formatDate(selectedUser.createdAt)}</div>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-600 dark:text-gray-400">Modifié le</label>
                      <div className="text-gray-900 dark:text-gray-100">{formatDate(selectedUser.updatedAt)}</div>
                    </div>
                  </div>
                  
                  <div>
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-400">ID</label>
                    <div className="text-gray-900 dark:text-gray-100 font-mono text-xs">{selectedUser.id}</div>
                  </div>
                </div>
              )}
