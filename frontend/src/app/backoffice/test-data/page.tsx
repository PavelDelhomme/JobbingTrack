...
export default function TestDataGeneratorPage() {
  ...
  const fetchAvailableUsers = async () => {
    try {
      ...
      setAvailableUsers([
        { id: '1', email: 'user1@jobbingtrack.com', role: 'SUPER_ADMIN', firstName: 'Pavel', lastName: 'Delhomme' },
        { id: '2', email: 'user2@jobbingtrack.com', role: 'ADMIN', firstName: 'Marie', lastName: 'Martin' },
        { id: '3', email: 'user3@jobbingtrack.com', role: 'USER', firstName: 'Thomas', lastName: 'Bernard' }
      ])
    }
  }
