          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">user1@jobbingtrack.com</p>
            ...
            <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
              <span className="text-2xl">👨‍💼</span>
              <div className="flex-1">
                <p className="font-medium text-gray-900">user2@jobbingtrack.com</p>
            ...
            <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
              <span className="text-2xl">👤</span>
              <div className="flex-1">
                <p className="font-medium text-gray-900">user3@jobbingtrack.com</p>
