      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <MetricsErrorBoundary>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {systemMetrics && systemMetrics.memory && systemMetrics.memory.usage !== 'N/A' && systemMetrics.memory.usage !== null ? `${typeof systemMetrics.memory.usage === 'number' ? systemMetrics.memory.usage.toFixed(1) : systemMetrics.memory.usage}%` : 'N/A'}
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Mémoire</div>
              {systemMetrics && systemMetrics.memory && systemMetrics.memory.usage !== 'N/A' && systemMetrics.memory.usage !== null && (
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-2">
                  <div className="bg-green-500 h-2 rounded-full transition-all" style={{ width: `${systemMetrics.memory.usage}%` }}></div>
                </div>
              )}
            </div>
