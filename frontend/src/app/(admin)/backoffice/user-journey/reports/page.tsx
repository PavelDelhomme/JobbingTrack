        ...
        <div className="p-6 flex items-center justify-center min-h-[200px]">
          {authLoading ? (
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Connectez-vous pour accéder aux rapports de parcours.
            </p>
          )}
        </div>
      </AdminLayout>
      ...
      <div className="p-4 lg:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Consulter et télécharger les rapports d&apos;exécution des
        ...
        {loading ? (
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Exécutez un parcours utilisateur (prédéfini ou personnalisé) pour
              générer des rapports.
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Les rapports sont enregistrés automatiquement après chaque
              exécution.
            </p>
          </div>
        ) : (
              ...
              <div className="space-y-3 max-h-[70vh] overflow-y-auto">
                {reports.map((report) => (
                  ...
                  >
                    ...
                    {(report.totalTests != null && report.totalTests > 0) ||
                    report.passed != null ||
                    report.failed != null ? (
