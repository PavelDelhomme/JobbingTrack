          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-300">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-700 dark:text-blue-400">
                <li>
                  Les éléments archivés sont conservés mais masqués des vues
                  principales
                </li>
                <li>
                  Vous pouvez désarchiver un élément à tout moment pour le
                  rendre actif
                </li>
...
function ArchivedItemRow({
  ...
  const daysSinceArchived = Math.floor(
    (new Date().getTime() - new Date(item.archivedAt).getTime()) /
      (1000 * 60 * 60 * 24),
  );
    ...
    <div className="p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 sm:gap-4 flex-1">
          {/* Type Badge */}
          <div
            className={`px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm font-medium ${typeColors[item.type]}`}
          >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 mt-1 text-sm text-gray-600 dark:text-gray-400">
              <span>
                Archivé il y a {daysSinceArchived} jour
                {daysSinceArchived > 1 ? "s" : ""}
              </span>
              {item.archivedBy && (
