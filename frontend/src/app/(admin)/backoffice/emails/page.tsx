  ...
  if (loading) {
    return (
      <EmailBackofficePageShell
        ...
        description="Dashboard de gestion et monitoring des emails envoyés."
      >
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {stats.global.total > 0
                  ? ((stats.global.failed / stats.global.total) * 100).toFixed(
                      1,
                    )
                  : 0}
                % d'échecs
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    ...
                    Cette fonctionnalité envoie un email de réinitialisation de
                    mot de passe à l'adresse spécifiée. L'email contiendra un
            ...
            >
              ...
              {sendResult.success && (
                <p className="text-sm text-green-700 dark:text-green-300 mt-2 ml-7">
                  💡 Vérifiez votre boîte mail (et les spams) pour confirmer la
