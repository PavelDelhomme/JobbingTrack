...
export default function APITesterPage() {
  ...
  const [selectedHistoryItem, setSelectedHistoryItem] =
    useState<RequestHistory | null>(null);
  ...
  useEffect(() => {
    if (token) {
      try {
        ...
        if (
          parsedHeaders["Authorization"] === "Bearer YOUR_TOKEN" ||
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      if (
        cleanEndpoint.endsWith("/api/v1/") ||
        cleanEndpoint.endsWith("/api/v1")
      ) {
        setResponse({
          error: true,
          message:
            "Endpoint incomplet. Veuillez spécifier une ressource (ex: /api/v1/health, /api/v1/users)",
          status: 400,
        });
        return;
      }
      ...
      if (error.response?.status === 401 || error.response?.status === 403) {
        ...
        if (!errorData) {
          errorData = {
            error: errorMessage,
            message:
              "Vérifiez que votre token est valide et présent dans les headers",
          };
        }
    ...
    reader.onload = (e) => {
      try {
        ...
        if (data.followRedirects !== undefined)
          setFollowRedirects(data.followRedirects);
  ...
  const servicesConfig = [
    ...
    },
    {
      ...
      port: 5006,
      healthPath: "/api/v1/applications/health",
      basePath: "/api/v1/applications",
    },
    {
      name: "Company Service",
      port: 5007,
      healthPath: "/api/v1/companies/health",
      basePath: "/api/v1/companies",
    },
    {
      name: "Contact Service",
      port: 5008,
      healthPath: "/api/v1/contacts/health",
      basePath: "/api/v1/contacts",
    },
    {
      name: "Interview Service",
      port: 5009,
      healthPath: "/api/v1/interviews/health",
      basePath: "/api/v1/interviews",
    },
    {
      name: "Call Service",
      port: 5010,
      healthPath: "/api/v1/calls/health",
      basePath: "/api/v1/calls",
    },
    {
      name: "Event Service",
      port: 5011,
      healthPath: "/api/v1/events/health",
      basePath: "/api/v1/events",
    },
    {
      name: "Followup Service",
      port: 5012,
      healthPath: "/api/v1/followups/health",
      basePath: "/api/v1/followups",
    },
    {
      name: "Profile Service",
      port: 5013,
      healthPath: "/api/v1/profile/health",
      basePath: "/api/v1/profile",
    },
    {
      name: "Notification Service",
      port: 5014,
      healthPath: "/api/v1/notifications/health",
      basePath: "/api/v1/notifications",
    },
    {
      name: "Dashboard Service",
      port: 5015,
      healthPath: "/api/v1/dashboard/health",
  ...
  const quickEndpoints = [
    ...
    {
      label: "Health Check (Gateway)",
      value: `${API_GATEWAY_URL}/health`,
      category: "health",
    },
    ...
    {
      label: "Services",
      value: `${API_GATEWAY_URL}/api/v1/services`,
      category: "system",
    },
    {
      label: "Métriques",
      value: `${API_GATEWAY_URL}/metrics`,
      category: "system",
    },
    ...
    {
      label: "Utilisateurs",
      value: `${API_GATEWAY_URL}/api/v1/users`,
      category: "auth",
    },
    {
      label: "Profil",
      value: `${API_GATEWAY_URL}/api/v1/auth/profile`,
      category: "auth",
    },
    {
      label: "Vérifier Token",
      value: `${API_GATEWAY_URL}/api/v1/auth/verify`,
      category: "auth",
    },
    {
      label: "Login",
      value: `${API_GATEWAY_URL}/api/v1/auth/login`,
      category: "auth",
    },
    {
      label: "Register",
      value: `${API_GATEWAY_URL}/api/v1/auth/register`,
      category: "auth",
    },
    ...
    {
      label: "Applications",
      value: `${API_GATEWAY_URL}/api/v1/applications`,
      category: "applications",
    },
    {
      label: "Entreprises",
      value: `${API_GATEWAY_URL}/api/v1/companies`,
      category: "applications",
    },
    {
      label: "Contacts",
      value: `${API_GATEWAY_URL}/api/v1/contacts`,
      category: "applications",
    },
    {
      label: "Recherche Applications",
      value: `${API_GATEWAY_URL}/api/v1/applications/search`,
      category: "applications",
    },
    {
      label: "Recherche Entreprises",
      value: `${API_GATEWAY_URL}/api/v1/companies/search`,
      category: "applications",
    },
    ...
    {
      label: "Entretiens",
      value: `${API_GATEWAY_URL}/api/v1/interviews`,
      category: "interviews",
    },
    {
      label: "Entretiens Aujourd'hui",
      value: `${API_GATEWAY_URL}/api/v1/interviews/today`,
      category: "interviews",
    },
    {
      label: "Entretiens À Venir",
      value: `${API_GATEWAY_URL}/api/v1/interviews/upcoming`,
      category: "interviews",
    },
    {
      label: "Appels",
      value: `${API_GATEWAY_URL}/api/v1/calls`,
      category: "interviews",
    },
    {
      label: "Historique Appels",
      value: `${API_GATEWAY_URL}/api/v1/calls/history`,
      category: "interviews",
    },
    ...
    {
      label: "Événements",
      value: `${API_GATEWAY_URL}/api/v1/events`,
      category: "events",
    },
    {
      label: "Événements Aujourd'hui",
      value: `${API_GATEWAY_URL}/api/v1/events/today`,
      category: "events",
    },
    {
      label: "Calendrier Événements",
      value: `${API_GATEWAY_URL}/api/v1/events/calendar`,
      category: "events",
    },
    {
      label: "Relances",
      value: `${API_GATEWAY_URL}/api/v1/followups`,
      category: "events",
    },
    {
      label: "Relances En Retard",
      value: `${API_GATEWAY_URL}/api/v1/followups/overdue`,
      category: "events",
    },
    {
      label: "Relances À Faire",
      value: `${API_GATEWAY_URL}/api/v1/followups/due`,
      category: "events",
    },
    ...
    {
      label: "Mon Profil",
      value: `${API_GATEWAY_URL}/api/v1/profiles/me`,
      category: "profiles",
    },
    {
      label: "Préférences",
      value: `${API_GATEWAY_URL}/api/v1/profiles/preferences`,
      category: "profiles",
    },
    {
      label: "Paramètres",
      value: `${API_GATEWAY_URL}/api/v1/profiles/settings`,
      category: "profiles",
    },
    {
      label: "Notifications",
      value: `${API_GATEWAY_URL}/api/v1/notifications`,
      category: "profiles",
    },
    {
      label: "Paramètres Notifications",
      value: `${API_GATEWAY_URL}/api/v1/notifications/settings`,
      category: "profiles",
    },
    ...
    // Dashboard & Analytics
    {
      ...
      value: `${API_GATEWAY_URL}/api/v1/dashboard/overview`,
      category: "dashboard",
    },
    {
      label: "Dashboard Analytics",
      value: `${API_GATEWAY_URL}/api/v1/dashboard/analytics`,
      category: "dashboard",
    },
    {
      label: "Dashboard Métriques",
      value: `${API_GATEWAY_URL}/api/v1/dashboard/metrics`,
      category: "dashboard",
    },
    {
      label: "Statistiques",
      value: `${API_GATEWAY_URL}/api/v1/statistics`,
      category: "dashboard",
    },
    {
      label: "Analytics Sessions",
      value: `${API_GATEWAY_URL}/api/v1/analytics/sessions`,
      category: "dashboard",
    },
    {
      label: "Analytics Events",
      value: `${API_GATEWAY_URL}/api/v1/analytics/events`,
      category: "dashboard",
    },
    ...
    {
      label: "Workflows",
      value: `${API_GATEWAY_URL}/api/v1/workflows`,
      category: "workflows",
    },
    {
      label: "Exécuter Workflow",
      value: `${API_GATEWAY_URL}/api/v1/workflows/{id}/execute`,
      category: "workflows",
    },
    {
      label: "Audit Sécurité",
      value: `${API_GATEWAY_URL}/api/v1/security/audit`,
      category: "workflows",
    },
    {
      label: "Alertes Sécurité",
      value: `${API_GATEWAY_URL}/api/v1/security/alerts`,
      category: "workflows",
    },
    {
      label: "Sessions Actives",
      value: `${API_GATEWAY_URL}/api/v1/security/sessions`,
      category: "workflows",
    },

    // Déploiement & Monitoring
    {
      label: "Status Déploiement",
      value: `${API_GATEWAY_URL}/api/v1/deployment/status`,
      category: "deployment",
    },
    {
      label: "Services Déploiement",
      value: `${API_GATEWAY_URL}/api/v1/deployment/services`,
      category: "deployment",
    },
    {
      label: "Health Déploiement",
      value: `${API_GATEWAY_URL}/api/v1/deployment/health`,
      category: "deployment",
    },
    {
      label: "Métriques Système",
      value: `${API_GATEWAY_URL}/api/v1/system-metrics`,
      category: "deployment",
    },
    {
      label: "Historique Déploiement",
      value: `${API_GATEWAY_URL}/api/v1/deployment/history`,
      category: "deployment",
    },
  ];
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          <div className="mb-4">
              ...
              >
                <h3 className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    (
                    {
                      quickEndpoints.filter((ep) => ep.category === "health")
                        .length
                    }
                    )
                  </span>
              ...
              >
                <h3 className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    (
                    {
                      quickEndpoints.filter((ep) => ep.category === "system")
                        .length
                    }
                    )
                  </span>
              ...
              >
                <h3 className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    (
                    {
                      quickEndpoints.filter((ep) => ep.category === "auth")
                        .length
                    }
                    )
                  </span>
            ...
            {[
              ...
              const categoryEndpoints = quickEndpoints.filter(
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                {queryParams.filter((p) => p.enabled && p.key && p.value)
                  .length > 0 && (
                ...
                {queryParams.map((param, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span
                        className={`font-semibold ${isActive ? "text-green-600 dark:text-green-400" : "text-gray-400"}`}
                      >
                        =
                      </span>
                      <input
            ...
            <div>
              ...
              {!token && (
                <p className="mt-1 text-xs text-yellow-600 dark:text-yellow-400">
                  ⚠️ Vous n'êtes pas connecté. Certaines requêtes nécessitent
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="p-4 overflow-y-auto flex-1 space-y-4">
                      ...
                      <span
                        className={`ml-2 px-2 py-1 rounded text-xs font-semibold ${
                          selectedHistoryItem.method === "GET"
                            ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300"
                            : selectedHistoryItem.method === "POST"
                              ? "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300"
                              : selectedHistoryItem.method === "PUT"
                                ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300"
                                : selectedHistoryItem.method === "DELETE"
                                  ? "bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300"
                                  : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                        }`}
                      >
                ...
                {/* Query Parameters */}
                {selectedHistoryItem.queryParams &&
                  selectedHistoryItem.queryParams.length > 0 && (
                    <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                      <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
