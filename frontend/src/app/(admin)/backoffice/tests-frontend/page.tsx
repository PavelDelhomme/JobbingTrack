...
export default function FrontendTestsPage() {
  ...
  const [availableTests, setAvailableTests] = useState<TestItem[]>([
    {
      id: 'components',
      name: 'Tests Unitaires Composants',
      description: 'Tests unitaires de tous les composants React',
      category: 'Composants',
      enabled: true
    },
    {
      id: 'hooks',
      name: 'Tests Hooks',
      description: 'Tests des hooks personnalisés (useAuth, etc.)',
      category: 'Composants',
      enabled: true
    },
    {
      id: 'pages',
      name: 'Tests Pages',
      description: 'Tests de rendu et navigation des pages',
      category: 'Pages',
      enabled: true
    },
    {
    ...
    {
      id: 'utils',
      name: 'Tests Utilitaires',
      description: 'Tests des fonctions utilitaires et helpers',
    ...
    },
    {
      id: 'rendering',
      name: 'Tests de Rendu',
      description: 'Tests de rendu conditionnel et affichage',
      category: 'Rendu',
      enabled: true
    },
    {
      id: 'interactions',
      name: 'Tests d\'Interactions',
      description: 'Tests des interactions utilisateur (clics, formulaires)',
  ...
  const startFrontendTests = async () => {
    if (isRunning) {
                ...
                {testStatuses.map((test, idx) => (
                  <div key={idx} className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      {test.status === 'running' && <Loader2 className="w-4 h-4 animate-spin text-green-500" />}
