...
import { 
  ...
  FileText, Building2, Users, Calendar, Phone, Mail, Bell
} from 'lucide-react'
...
export default function DataManagementTab() {
  ...
  const [stats, setStats] = useState<DataStats>({ applications: 0, companies: 0, contacts: 0, users: 0 })
        ...
        {statsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.applications}</p>
            </div>
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">{stats.contacts}</p>
            </div>
            <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400">Utilisateurs</p>
              <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">{stats.users}</p>
            </div>
          </div>
        )}
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
          Accédez aux listes détaillées via les onglets ci-dessus ou les liens ci-dessous.
        </p>
        <div className="flex flex-wrap gap-2 mt-3">
          {[
            ...
            <button
              key={tab}
              type="button"
              onClick={() => router.push(`/b4ck0ff1ce/datas?tab=${tab}`)}
