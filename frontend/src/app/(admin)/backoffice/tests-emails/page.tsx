  ...
  const handleSend = async (type: EmailTestType) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setResult({
          success: false,
          message: res.data.error || "Erreur lors de l'envoi",
        });
      }
    } catch (e: any) {
      setResult({
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Testez tous les types d&apos;emails : test générique,
              réinitialisation mot de passe, vérification compte.
            </p>
          </div>
          <Link
        ...
        <Card>
          ...
          <CardContent>
            ...
            {result && (
              <div
                className={`mt-4 flex items-center gap-2 p-3 rounded-lg ${result.success ? "bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-300" : "bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-300"}`}
              >
                {result.success ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <Card className="hover:border-blue-400 transition-colors cursor-pointer h-full">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Ouvrir l&apos;interface MailHog pour voir les emails capturés
                  en local.
                </p>
              </CardContent>
            </Card>
