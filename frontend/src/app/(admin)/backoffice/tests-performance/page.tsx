    ...
    try {
      ...
      if (history && history.length > 0) {
        ...
        const newPoint: MetricPoint = {
          ...
          availability_percent: parseFloat(
            String(latest.availability_percent || 100),
          ),
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                    {currentTest.elapsedTime.toFixed(1)}s /{" "}
                  ...
                  <div className="mt-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${(currentTest.elapsedTime / testConfig.duration) * 100}%`,
                      }}
                    />
                  </div>
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          {metricsData.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-96 text-gray-500 dark:text-gray-400">
              ...
              <p className="text-sm">
                Lancez un test pour commencer à collecter des métriques
              </p>
            </div>
          ) : (
        ...
        {metricsData.length > 0 && (
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {selectedMetrics.map((metricKey) => {
              ...
              const values = metricsData.map(
                (d) => d[metricKey as keyof MetricPoint] as number,
              );
