...
export function ReportIframe({ content, isFullscreen }: { content: string; isFullscreen: boolean }) {
  ...
  if (!src) return <div className="p-4 text-gray-500">Chargement du rapport...</div>
  return (
    <iframe
      src={src}
