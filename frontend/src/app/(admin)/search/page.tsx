  ...
  const exportResults = () => {
    ...
    const csvContent = [
      ...
      ...allResults.map((result) =>
        [
          getModuleLabel(
            results.find((r) => r.results?.includes(result))?.module ||
              "unknown",
          ),
          formatResult(
            result,
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Recherche intelligente avec indexation côté client
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
              <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-blue-700 dark:text-blue-300">
                  Recherche instantanée dans les données mises en cache, même
                  hors ligne
                </p>
              </div>
              ...
              <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <p className="text-green-700 dark:text-green-300">
                  Combine recherche en ligne et index local pour des résultats
                  optimaux
                </p>
              </div>
