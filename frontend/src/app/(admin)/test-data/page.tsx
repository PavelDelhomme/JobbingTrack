      ...
      <div>
        ...
        <div className="mb-4 sm:mb-6 md:mb-8">
          ...
          <p className="text-xs sm:text-sm md:text-base text-gray-600 dark:text-gray-400 mt-1 md:mt-2">
            Générez des données réalistes et cohérentes pour tester
            l'application
          </p>
        </div>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 dark:border-yellow-600 p-3 sm:p-4 mb-4 sm:mb-6 md:mb-8">
          <div className="flex">
            <div className="flex-shrink-0">
              <span className="text-yellow-400 dark:text-yellow-500 text-2xl">
                ⚠️
              </span>
            </div>
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                <p>
                  Cette fonctionnalité est destinée aux environnements de
                  développement et staging.
                </p>
        ...
        {/* Presets - Responsive */}
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">
            ...
            {presets.map((preset) => (
              ...
              >
                ...
                <div className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">
                  {Object.values(preset.config).reduce(
                    (sum, val) => sum + val,
                    0,
                  )}{" "}
                  éléments au total
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-4 md:p-6 mb-4 md:mb-8">
          <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4 md:mb-6">
            🎯 Sélection des données à générer
          </h2>
          ...
          <div className="border-t border-gray-200 dark:border-gray-600 pt-4 md:pt-6">
            <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 md:mb-4">
              👤 Sélection des utilisateurs
            </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    {availableUsers.map((user) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={userSelection.selectedUsers.includes(
                            user.id,
                          )}
                          onChange={(e) => {
                            if (e.target.checked) {
                              ...
                              setUserSelection({
                                ...userSelection,
                                selectedUsers:
                                  userSelection.selectedUsers.filter(
                                    (id) => id !== user.id,
                                  ),
                              });
                            }
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  Total d'éléments à générer
                </p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">
                  {totalItems}
                </p>
              </div>
              <div className="text-gray-400 dark:text-gray-500 text-4xl sm:text-5xl md:text-6xl">
                🎲
              </div>
            </div>
          </div>
              ...
              <button
                onClick={() => {
                  ...
                  fetch("/api/test/run-api-tests")
                    ...
                    .catch(() =>
                      alert("Erreur lors du lancement des tests API"),
                    );
                }}
              ...
              <button
                onClick={() => {
                  ...
                  fetch("/api/test/run-performance-tests")
                    ...
                    .catch(() =>
                      alert(
                        "Erreur lors du lancement des tests de performance",
                      ),
                    );
                }}
              ...
              <button
                onClick={() => {
                  ...
                  fetch("/api/test/run-security-tests")
                    ...
                    .catch(() =>
                      alert("Erreur lors du lancement des tests de sécurité"),
                    );
                }}
              ...
              <button
                onClick={() => {
                  ...
                  fetch("/api/test/run-mobile-tests")
                    ...
                    .catch(() =>
                      alert("Erreur lors du lancement des tests mobile"),
                    );
                }}
              ...
              <button
                onClick={() => {
                  ...
                  fetch("/api/test/run-all-tests")
                    ...
                    .catch(() =>
                      alert("Erreur lors du lancement de la suite de tests"),
                    );
                }}
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-blue-800 dark:text-blue-200">
                <li className="flex items-start gap-2">
                  <span>1️⃣</span>
                  <span>
                    <strong>Choisissez un preset</strong> ou personnalisez la
                    configuration avec les sliders
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>2️⃣</span>
                  <span>
                    <strong>Cliquez sur "Générer"</strong> pour créer les
                    données (peut prendre quelques secondes)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>3️⃣</span>
                  <span>
                    <strong>Les données générées</strong> incluent des relations
                    cohérentes entre les entités
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>4️⃣</span>
                  <span>
                    <strong>Les comptes de test</strong> sont créés avec le mot
                    de passe :{" "}
                ...
                <li className="flex items-start gap-2">
                  <span>5️⃣</span>
                  <span>
                    <strong>Utilisez "Tout supprimer"</strong> pour nettoyer
              ...
              <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-blue-200 dark:border-blue-700">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-blue-700 dark:text-blue-300">
                  <div>
                    ✅ Utilisateurs avec différents rôles (USER, ADMIN,
                    SUPER_ADMIN)
                  </div>
        ...
        <div className="mt-4 sm:mt-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-3 sm:p-4 md:p-6">
          <h3 className="text-sm sm:text-base font-semibold text-green-900 dark:text-green-100 mb-3">
          ...
          <div className="space-y-2 text-xs sm:text-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white dark:bg-gray-800 rounded-lg">
              ...
              <code className="px-2 sm:px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded text-[10px] sm:text-xs text-gray-700 dark:text-gray-300 flex-shrink-0">
                password123
              </code>
            </div>
