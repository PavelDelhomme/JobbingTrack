...
export default function SecurityAnalysisPage() {
  ...
  const [systemMetrics, setSystemMetrics] = useState<SecurityMetrics | null>(
    null,
  );
  const [riskAnalysis, setRiskAnalysis] = useState<SecurityRiskAnalysis | null>(
    null,
  );
      ...
      const mockRiskAnalysis = {
        ...
        recommendations: [
          ...
          },
          {
            ...
            description:
              "Vérifier les permissions utilisateur sur les endpoints sensibles",
            priority: "medium",
          },
        ],
      };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 dark:text-yellow-300">
                  Impossible de joindre l&apos;API Gateway sur{" "}
                  <code className="text-xs bg-yellow-100 dark:bg-yellow-900/40 px-1 rounded">
                    {API_URL}
                  </code>
                  . Vérifiez la configuration API centralisée et que les
                  services Docker tournent.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={`text-3xl font-bold ${riskAnalysis.overallRisk === "critical" || riskAnalysis.overallRisk === "high" ? "text-red-600 dark:text-red-400" : riskAnalysis.overallRisk === "medium" ? "text-yellow-600 dark:text-yellow-400" : "text-green-600 dark:text-green-400"}`}
                    >
                      {Number(systemMetrics.averageRiskScore).toFixed(1)}
                    </p>
                  </div>
                  <div
                    className={`${riskAnalysis.overallRisk === "critical" || riskAnalysis.overallRisk === "high" ? "text-red-500" : riskAnalysis.overallRisk === "medium" ? "text-yellow-500" : "text-green-500"}`}
                  >
                    <svg
                      className="w-8 h-8"
                      fill="currentColor"
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                  Risque global:{" "}
                  <span
                    className={`font-medium ${getRiskColor(riskAnalysis.overallRisk)}`}
                  >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-red-600 dark:text-red-400">
                      {systemMetrics.intrusionAttempts}
                    </p>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-yellow-600 dark:text-yellow-400">
                      {riskAnalysis.vulnerabilityAssessment.total}
                    </p>
                  </div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                  {riskAnalysis.vulnerabilityAssessment.critical} critiques,{" "}
                  {riskAnalysis.vulnerabilityAssessment.high} élevées
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    ...
                    <span
                      className={`px-2 py-1 text-xs rounded-full font-medium ${getRiskColor(riskAnalysis.overallRisk)}`}
                    >
                      {riskAnalysis.overallRisk.toUpperCase()}
                    </span>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div className="h-48 flex items-end justify-between gap-1">
                  {riskAnalysis.attackTrends.hourly
                    .slice(-24)
                    .map((trend: any, index: number) => {
                      ...
                      const currentTotal = Number.isFinite(Number(trend.total))
                        ? Number(trend.total)
                        : 0;
                      const height =
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-red-600 dark:text-red-400">
                    {riskAnalysis.vulnerabilityAssessment.critical}
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                    {riskAnalysis.vulnerabilityAssessment.high}
                  </p>
                </div>
                <div className="text-center">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                  ...
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                    {typeof riskAnalysis.vulnerabilityAssessment.averageCVSS ===
                    "number"
                      ? riskAnalysis.vulnerabilityAssessment.averageCVSS.toFixed(
                          1,
                        )
