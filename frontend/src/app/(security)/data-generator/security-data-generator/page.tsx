...
export default function SecurityDataGeneratorPage() {
  ...
  const loadGenerationStatus = async () => {
    try {
      ...
      console.error(
        "Erreur lors du chargement du statut de génération:",
        error,
      );
    }
  };
  ...
  const generateOneTimeData = async () => {
    ...
    try {
      const response = await axios.post(
        `${API_URL}/api/v1/security/generate-dev-data`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Configuration et gestion de la génération automatique de données de
            sécurité réalistes
          </p>
        </div>
          ...
          <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>
                  Tentatives d'intrusion (SQL Injection, XSS, Brute Force)
                </li>
            ...
            <div>
              ...
              <p>
                Les IPs sont automatiquement géolocalisées avec des pays
                réalistes (US, CN, RU, FR, etc.)
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Les événements à haut risque génèrent automatiquement des
                alertes de sécurité et des tentatives d'intrusion
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Les données sont générées avec des timestamps réalistes et des
                scores de risque appropriés
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-700 dark:text-blue-300 mt-1">
                  Ce générateur est destiné uniquement à des fins de
                  développement et de test. En production, les données de
                  sécurité proviennent des vraies requêtes et analyses du
                  système.
                </p>
              </div>
            </div>
