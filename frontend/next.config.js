...
const useTopLevelTurbopack =
  nv.major > 15 || (nv.major === 15 && nv.minor >= 3);
...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_APPLICATION_SERVICE_PORT:
      process.env.APPLICATION_SERVICE_PORT || "8002",
    NEXT_PUBLIC_COMPANY_SERVICE_PORT:
      process.env.COMPANY_SERVICE_PORT || "8003",
    NEXT_PUBLIC_CONTACT_SERVICE_PORT:
      process.env.CONTACT_SERVICE_PORT || "8004",
    NEXT_PUBLIC_INTERVIEW_SERVICE_PORT:
      process.env.INTERVIEW_SERVICE_PORT || "8005",
    ...
    NEXT_PUBLIC_FOLLOWUP_SERVICE_PORT:
      process.env.FOLLOWUP_SERVICE_PORT || "8008",
    NEXT_PUBLIC_METRICS_AGGREGATOR_PORT:
    ...
    NEXT_PUBLIC_METRICS_URL:
      process.env.NEXT_PUBLIC_METRICS_URL || "/api/metrics-aggregator",
    NEXT_PUBLIC_METRICS_AGGREGATOR_URL:
      process.env.NEXT_PUBLIC_METRICS_AGGREGATOR_URL ||
      "/api/metrics-aggregator",
    NEXT_PUBLIC_FRONTEND_URL:
      process.env.NEXT_PUBLIC_FRONTEND_URL ||
      `https://jobbingtrack.localhost:${process.env.DEV_HTTPS_PORT || "5443"}`,
    NEXT_PUBLIC_DEV_HTTPS_PORT: process.env.DEV_HTTPS_PORT || "5443",
    NEXT_PUBLIC_DISABLE_METRICS_WEBSOCKET:
      process.env.NEXT_PUBLIC_DISABLE_METRICS_WEBSOCKET || "false",
  },
  compiler: {
    removeConsole:
